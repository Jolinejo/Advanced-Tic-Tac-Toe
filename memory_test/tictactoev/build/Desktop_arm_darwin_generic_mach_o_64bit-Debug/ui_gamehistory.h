...
class Ui_gameHistory {
 public:
  ...
  void retranslateUi(QDialog *gameHistory) {
    gameHistory->setWindowTitle(
        QCoreApplication::translate("gameHistory", "Dialog", nullptr));
    ...
    pushButton_play->setText(
        QCoreApplication::translate("gameHistory", "Play", nullptr));
    label_of_winner->setText(
        QCoreApplication::translate("gameHistory", "TextLabel", nullptr));
  }  // retranslateUi
};
