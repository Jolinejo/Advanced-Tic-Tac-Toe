...
class Ui_Dialog {
 public:
  ...
  void setupUi(QDialog *Dialog) {
    if (Dialog->objectName().isEmpty()) Dialog->setObjectName("Dialog");
  ...
  void retranslateUi(QDialog *Dialog) {
    ...
    pushButton->setText(
        QCoreApplication::translate("Dialog", "start the game !", nullptr));
    pushButton_display1->setText(
        QCoreApplication::translate("Dialog", "PushButton", nullptr));
    pushButton_display2->setText(
        QCoreApplication::translate("Dialog", "PushButton", nullptr));
    pushButton_2->setText(
        QCoreApplication::translate("Dialog", "Sign out", nullptr));
  }  // retranslateUi
};
