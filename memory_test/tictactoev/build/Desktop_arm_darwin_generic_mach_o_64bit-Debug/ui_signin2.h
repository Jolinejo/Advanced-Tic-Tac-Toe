...
class Ui_signin2 {
 public:
  ...
  void setupUi(QDialog *signin2) {
    if (signin2->objectName().isEmpty()) signin2->setObjectName("signin2");
    signin2->resize(400, 300);
    groupBox = new QGroupBox(signin2);
    groupBox->setObjectName("groupBox");
    groupBox->setGeometry(QRect(100, 20, 231, 241));
    ...
    label_ifthere = new QLabel(groupBox);
    label_ifthere->setObjectName("label_ifthere");
    label_ifthere->setStyleSheet(QString::fromUtf8("color: #f9f02e;"));
  ...
  void retranslateUi(QDialog *signin2) {
    signin2->setWindowTitle(
        QCoreApplication::translate("signin2", "Dialog", nullptr));
    groupBox->setTitle(
        QCoreApplication::translate("signin2", "Player2 SignIn", nullptr));
    label->setText(
        QCoreApplication::translate("signin2", "User Name", nullptr));
    label_2->setText(
        QCoreApplication::translate("signin2", "Password", nullptr));
    pushButton_login2->setText(
        QCoreApplication::translate("signin2", "Login", nullptr));
    label_ifthere->setText(QString());
    checkBox_showpassword->setText(
        QCoreApplication::translate("signin2", "show password", nullptr));
    label_3->setText(
        QCoreApplication::translate("signin2", "Don't have account!", nullptr));
    pushButton_signup2->setText(
        QCoreApplication::translate("signin2", "Sign up", nullptr));
  }  // retranslateUi
};
