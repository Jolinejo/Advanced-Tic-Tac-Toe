...
class Ui_signin {
 public:
  ...
  void setupUi(QDialog *signin) {
    if (signin->objectName().isEmpty()) signin->setObjectName("signin");
    signin->resize(400, 300);
    groupBox = new QGroupBox(signin);
    groupBox->setObjectName("groupBox");
    groupBox->setGeometry(QRect(120, 40, 231, 241));
    ...
    label_4->setStyleSheet(QString::fromUtf8("color: #f9f02e;"));
  ...
  void retranslateUi(QDialog *signin) {
    signin->setWindowTitle(
        QCoreApplication::translate("signin", "Dialog", nullptr));
    groupBox->setTitle(
        QCoreApplication::translate("signin", "Player1 SignIn", nullptr));
    label->setText(QCoreApplication::translate("signin", "User Name", nullptr));
    label_2->setText(
        QCoreApplication::translate("signin", "Password", nullptr));
    pushButton_login->setText(
        QCoreApplication::translate("signin", "Login", nullptr));
    label_4->setText(QString());
    checkBox_showpassword->setText(
        QCoreApplication::translate("signin", "show password", nullptr));
    label_3->setText(
        QCoreApplication::translate("signin", "Dont't have account!", nullptr));
    pushButton_signup1->setText(
        QCoreApplication::translate("signin", "Sign up", nullptr));
  }  // retranslateUi
};
