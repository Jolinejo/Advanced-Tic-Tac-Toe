...
public:
    ...
    void setupUi(QDialog *gameHistory)
    {
        ...
        gameHistory->resize(436, 405);
        gameHistory->setStyleSheet(QString::fromUtf8("QLabel { font-size: 30px; }"));
        gridLayoutWidget = new QWidget(gameHistory);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(30, 90, 371, 271));
        ...
        splitter->setGeometry(QRect(30, 40, 371, 28));
        splitter->setOrientation(Qt::Horizontal);
        pushButton_play = new QPushButton(splitter);
        pushButton_play->setObjectName("pushButton_play");
        pushButton_play->setStyleSheet(QString::fromUtf8("font: 700 7pt \"Segoe UI\";\n"
""));
        ...
        label_of_winner->setStyleSheet(QString::fromUtf8("font-size: 15px;"));
